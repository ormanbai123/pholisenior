...
$(Source)/parser : $(Source)/identifier.o $(Source)/errorstack.o $(Source)/parsing/main.o $(Source)/parsing/tokenizer.o $(Source)/parsing/parser.o $(Source)/parsing/symbol.o $(Source)/parsing/evaluator.o $(Source)/parsing/util.o $(Source)/logic/type.o $(Source)/logic/selector.o $(Source)/logic/printing.o $(Source)/logic/structdef.o $(Source)/logic/term.o $(Source)/logic/uniquenamestack.o $(Source)/logic/pretty.o $(Source)/logic/counting.o $(Source)/logic/context.o $(Source)/logic/belief.o $(Source)/logic/beliefstate.o $(Source)/logic/kbo.o $(Source)/logic/position.o $(Source)/logic/replacements.o $(Source)/logic/structural.o $(Source)/lexing2023/filereader.o $(Source)/lexing2023/partition.o $(Source)/lexing2023/stateset.o
	$(CPP) $(Options) -o $(Source)/parser $(Source)/identifier.o $(Source)/errorstack.o $(Source)/parsing/main.o $(Source)/parsing/tokenizer.o $(Source)/parsing/parser.o $(Source)/parsing/symbol.o $(Source)/parsing/evaluator.o $(Source)/parsing/util.o $(Source)/logic/type.o $(Source)/logic/selector.o $(Source)/logic/printing.o $(Source)/logic/structdef.o $(Source)/logic/term.o $(Source)/logic/uniquenamestack.o $(Source)/logic/pretty.o $(Source)/logic/counting.o $(Source)/logic/context.o $(Source)/logic/belief.o $(Source)/logic/beliefstate.o $(Source)/logic/kbo.o $(Source)/logic/position.o $(Source)/logic/replacements.o $(Source)/logic/structural.o $(Source)/lexing2023/filereader.o $(Source)/lexing2023/partition.o $(Source)/lexing2023/stateset.o $(Libs)
...
$(Source)/parsing/symbol.o : $(Source)/parsing/symbol.cpp $(Source)/parsing/location.h $(Source)/parsing/symbol.h $(Util)/./identifier.h $(Util)/./logic/belief.h $(Util)/./logic/beliefstate.h $(Util)/./logic/exact.h $(Util)/./logic/proof.h $(Util)/./logic/selector.h $(Util)/./logic/structdef.h $(Util)/./logic/term.h $(Util)/./logic/type.h $(Util)/./parsing/util.cpp $(Util)/./parsing/util.h $(Util)/./util/hashbuilder.h $(Util)/identifier.h $(Util)/tvm/concepts.h $(Util)/tvm/distinct.h $(Util)/tvm/field.h $(Util)/tvm/hexprint.h $(Util)/tvm/includes.h $(Util)/tvm/local.h $(Util)/tvm/scalar.h $(Util)/tvm/scalar_list.h $(Util)/tvm/scalar_vector.h $(Util)/tvm/unit.h $(Util)/util/hashbuilder.h $(Util)/util/print.h
...
$(Source)/parsing/util.o : $(Source)/parsing/util.cpp $(Source)/parsing/util.h $(Util)/./identifier.h $(Util)/./logic/belief.h $(Util)/./logic/beliefstate.h $(Util)/./logic/exact.h $(Util)/./logic/proof.h $(Util)/./logic/selector.h $(Util)/./logic/structdef.h $(Util)/./logic/term.h $(Util)/./logic/type.h $(Util)/./util/hashbuilder.h $(Util)/identifier.h $(Util)/tvm/concepts.h $(Util)/tvm/distinct.h $(Util)/tvm/field.h $(Util)/tvm/hexprint.h $(Util)/tvm/includes.h $(Util)/tvm/local.h $(Util)/tvm/scalar.h $(Util)/tvm/scalar_list.h $(Util)/tvm/scalar_vector.h $(Util)/tvm/unit.h $(Util)/util/hashbuilder.h $(Util)/util/print.h
	$(CPP) -c $(Options) $(Source)/parsing/util.cpp -o $(Source)/parsing/util.o -I $(Lexing) -I $(Util) -I $(Maph) -I $(Source)
